#######################################################################################
# Yourname: Jessada Taengsuwan
# Your student ID: 65070041
# Your GitHub Repo: https://github.com/NitruZx/IPA2024-Final
...
ACCESS_TOKEN = os.environ.get('ACCESS_TOKEN', "No access_token is set")
...
roomIdToGetMessages = (
    "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vYjA4OTgwMjAtODNlNy0xMWVmLTgxYTEtYTVmZmU0MjA0NDNj"
)
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.startswith("/65070041"):

        # extract the command
        command = message.split("/65070041")[1].strip()
        print(command)
